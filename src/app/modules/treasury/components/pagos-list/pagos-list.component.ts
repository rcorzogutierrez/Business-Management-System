          ...
          <div class="flex items-center gap-3 flex-wrap">
            ...
            <div class="hidden md:flex items-center gap-2">
              <div class="flex flex-col items-center justify-center rounded-lg px-4 py-2 min-w-[75px] bg-red-50 border border-red-200">
                <span class="text-base font-bold leading-tight text-red-600">{{ filteredPagos().length }}</span>
                <span class="text-[10px] uppercase tracking-wider font-medium mt-1 text-red-500">Registros</span>
              </div>
              <div class="flex flex-col items-center justify-center rounded-lg px-4 py-2 min-w-[90px] bg-gradient-to-br from-red-50 to-red-100 border-2 border-red-200 shadow-sm">
                <span class="text-base font-bold leading-tight text-red-600">{{ totalAmount() | currency:'USD':'symbol-narrow':'1.0-0' }}</span>
                <span class="text-[10px] uppercase tracking-wider font-medium mt-1 text-red-500">Total</span>
              </div>
            </div>
